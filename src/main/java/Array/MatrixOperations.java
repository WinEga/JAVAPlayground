...
public class MatrixOperations {
    ...
    public static void printMatrix (double[][] matrix, int id) {
        ...
        switch (id) {
            case 1:
                System.out.print (MessageFormat.format ("First given matrix[{0}][{1}]:", rows, cols));
                break;
            case 2:
                System.out.print (MessageFormat.format ("Second given matrix[{0}][{1}]:", rows, cols));
                break;
            case 3:
                System.out.print (MessageFormat.format ("Resultant matrix[{0}][{1}]:", rows, cols));
                break;
            case 4:
                System.out.print (MessageFormat.format ("Inverse matrix[{0}][{1}]:", rows, cols));
                break;
            default:
